  ...
  "items": [
    {
      ...
      "logo": null,
      "description": "Встроенный язык системы 1С:Предприятия. На стадии разработки конфигурации предназначен для описания алгоритмов функционирования прикладной задачи. Основной язык разработчика 1С.",
    ...
    },
    {
      ...
      "subcategory": "Языки программирования",
      "logo": null,
      "description": "Язык запросов основан на [SQL](https://ru.wikipedia.org/wiki/SQL), при этом содержит как ограничения так и расширения, ориентированные на отражение специфики финансово-экономических задач.",
    ...
    },
    {
      ...
      "subcategory": "Языки программирования",
      "logo": null,
      "description": "Платформа для разработки мобильных приложений. По факту используется тот же язык программирования, но есть ограничения. Платформа позволяет разработать и собрать приложение для мобильных устройств.",
    ...
    },
    {
      ...
      "subcategory": "Языки программирования",
      "logo": null,
      "description": "Технология \"1С:Предприятие.Элемент\" расширяет границы применения системы \"1С:Предприятие\". Например, она позволяет создавать приложения, ориентированные не только на бизнес, но и на конечного пользователя (консьюмерские) – кабинеты, витрины и т.п. В качестве основных компонентов технологии обозначены: - пользовательский интерфейс, ориентированный в первую очередь на работу в веб; - динамично развивающийся встроенный язык; - поддержка модульности разработки; - среда разработки, развернутая в облаке и доступная через браузер; - ориентация на работу решений в облаке, но будет поддержка и локальной установки (on-premise); - мобильность, что подразумевает возможность работы приложения на мобильных устройствах и в мобильных браузерах сразу «из коробки».",
    ...
    },
    {
      ...
      "subcategory": "Языки программирования",
      "logo": null,
      "description": "1С:Предприятие.Элемент Скрипт — это среда выполнения для скриптов, написанных на языке 1С:Элемент. Основные возможности среды разработки: - встроенный редактор кода с функциями поиска, подсветки синтаксиса, автодополнения, проверки и форматирования кода; - отображение контекстной подсказки во время ввода текста и показ синтаксической справки при наведении мыши на код; - механизм отладки с возможностью задавать точки останова, просматривать значения переменных и пошагово выполнять код; - настройка конфигураций запуска и отладки скриптов; - базовая поддержка системы контроля версий Git для работы с существующими локальными репозиториями.",
    ...
    },
    {
      ...
      "subcategory": "Языки программирования",
      "logo": null,
      "description": "Проект является независимой кросс-платформенной реализацией виртуальной машины, исполняющей скрипты на языке 1С:Предприятие. При этом не требуется установка системы 1С:Предприятие на целевой машине. Основные возможности: - Использование в качестве среды исполнения текстовых сценариев на языке 1С; - Построение консольных приложений, написанных на языке 1С; - Встраивание в стороннюю программную среду в качестве среды исполнения текстовых сценариев на языке 1С.",
    ...
    },
    {
      ...
      "subcategory": "IDE",
      "logo": null,
      "description": "Конфигуратор - предметно-ориентированная среда быстрой разработки, существующая в платформе 1С:Предприятия 8. Предоставляет программисту инструменты для разработки и поддержки конфигураций.",
    ...
    },
    {
      ...
      "subcategory": "IDE",
      "logo": null,
      "description": "1C:EDT это современная расширяемая среда разработки прикладных решений. Она создана на основе свободной интегрированной среды разработки модульных кроссплатформенных приложений Eclipse. Преимущества: 1. Подсветка не соответствий стандартам. Джуны сразу пишут лучше 2. Встроенная работа с Git 3. Контекстная подсказка понимает, что возвращают функции. Видит свойства структур и соответствий 4. Поддерживает установку плагинов. Например, [1с:Напарник](#плагин-1снапарник) 5. Продукт активно улучшается",
      "why": "Используется для разработки и доработки конфигураций.",
    ...
    },
    {
      ...
      "subcategory": "IDE",
      "logo": null,
      "description": "\"Легкий\" и бесплатный редактор кода для кроссплатформенной разработки приложений. Включает в себя инструменты для работы с git, отладчик, подсветку синтаксиса и прочее.",
    ...
    },
    {
      ...
      "logo": null,
      "description": "TurboConf повышает эффективность работы в Конфигураторе 1С и помогает автоматизировать рутинные задачи. Программа добавляет в Конфигуратор десятки возможностей, которые делают разработку в Конфигураторе намного удобнее и быстрее. Основные возможности: - Показывает подсказки и ускоряет ввод текста - Проверяет код модулей на скрытые ошибки - Упрощает навигацию между объектами конфигурации - Генерирует и автоматически завершает фрагменты кода - Помогает красиво оформить текст модулей - Создает и ищет шаблоны кода в облачном сервисе",
    ...
    },
    {
      ...
      "subcategory": "Плагины и библиотеки",
      "logo": null,
      "description": "Интегрированный набор инструментов разработчика: консоль кода, консоль запросов, консоль построителя отчетов, консоль компоновки данных, консоль заданий, конструктор запроса, справочник алгоритмов, исследователь объектов, интерфейсная панель, настройка журнала регистрации, анализ журнала регистрации, настройка техножурнала, анализ техножурнала, подбор и обработка объектов, редактор объекта БД, редактор констант, редактор параметров сеанса, редактор изменений по плану обмена, редактор пользователей, редактор предопределенных, редактор хранилищ настроек, динамический список, поиск дублей и замена ссылок, контекстная подсказка, синтакс-помощник, поиск битых ссылок, поиск ссылок на объект, структура хранения БД, удаление объектов с контролем ссылок, и прочее",
    ...
    },
    {
      ...
      "subcategory": "Плагины и библиотеки",
      "logo": null,
      "description": "Набор инструментов для анализа и обработки данных в информационной базе 1С. - Консоль разработчика (консоль запросов, кода, СКД) - Редактор объекта - Редактор констант - Поиск и замена ссылок - Поиск ссылок - Монитор лицензий - Подписки на события - Пользователи - Регламентные и фоновые задания - Все функции - Глобальное меню - Редактор параметров сеанса",
      "why": "Набор инструментов разработчика, который помогает в ежедневной работе.",
    ...
    },
    {
      ...
      "subcategory": "Плагины и библиотеки",
      "logo": null,
      "description": "Проект позволяет анализировать и форматировать код 1С в конфигураторе. Инструмент основан на проекте BSL LS.",
    ...
    },
    {
      ...
      "subcategory": "Плагины и библиотеки",
      "logo": null,
      "description": "Умный ассистент, который подскажет решение, исправит ошибки, напишет комментарии на базе ИИ. Официальный плагин 1С для EDT. Доступен партнерам фирмы \"1С\" и по запросу на ailab@1c.ru",
    ...
    },
    {
      ...
      "subcategory": "Плагины и библиотеки",
      "logo": null,
      "description": "Расширение для VSCode (и Cursor), объединяющее инструменты разработки на платформе 1С в едином интерфейсе редактора.",
    ...
    },
    {
      ...
      "subcategory": "Плагины и библиотеки",
      "logo": null,
      "description": "1С:EDT позволяет дополнить стандартный инструментарий среды с помощью плагинов. Официальные плагины от 1С: - [1С:Language Tool](https://its.1c.ru/db/edtplugins#bookmark:languagetool:LanguageTool) - инструмент перевода исходного кода и локализации интерфейса - [1C:SSL-support](https://its.1c.ru/db/edtplugins#bookmark:sslsupport:SSLsupport) - поддержка разработки конфигураций на базе Библиотеки Стандартных Подсистем - [1С:Стандарты разработки V8](https://its.1c.ru/db/edtplugins#bookmark:v8codestyle:V8CodeStyle) - разработка по стандартам 1С, проверки, инструменты",
    ...
    },
    {
      ...
      "subcategory": "Плагины и библиотеки",
      "logo": null,
      "description": "Основную мощь экосистемы OneScript составляют готовые библиотеки, разрабатываемые сообществом. При разработке собственных решений можете подключить к программе готовые библиотеки и использовать их возможности. Готовые решения распространяются в виде пакетов. Пакет - это файл с расширением .ospx, который технически представляет собой zip-архив определенной структуры.",
      "why": "",
    ...
    },
    {
      ...
      "subcategory": "Плагины и библиотеки",
      "logo": null,
      "description": "Фреймворк компонентных приложений для OneScript. Он автоматизирует рутинную работу по созданию и связыванию компонентов, позволяя сосредоточиться на логике приложения. Основан на принципах инверсии управления (IoC) и внедрения зависимостей (DI), что делает код чище и проще для тестирования. - Позволяет строить масштабируемые приложения с чёткой структурой - Экономит время за счёт автоматической инициализации и связывания компонентов - Снижает связанность кода и облегчает поддержку",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Файловая СУБД — одна из систем управления базами данных, которую поддерживает платформа. Файловая СУБД разработана фирмой «1С» и является частью платформы. Хранит все данные в одном файле — файловой базе данных. Этот формат хранения данных разработан фирмой «1С» специально для прикладных решений 1С:Предприятия 8.",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Одна из СУБД, причем Фирма \"1С\" занимается поддержкой PostgreSQL и выпускает PostgreSQL от 1С Ключевые особенности PostgreSQL от 1С: - включает патчи с оптимизациями, выполненными разработчиками платформы 1С:Предприятия, которые учитывают особенности работы платформы 1С:Предприятие и типовых решений фирмы «1С»; - бесплатное использование PostgreSQL от 1С в промышленных коммерческих системах; - квалифицированная поддержка инженеров фирмы «1С»; - возможность бесплатного участия в пилотных проектах по переходу на PostgreSQL от 1С; - публикуется как в готовом для использования виде, так и в исходном коде; - используется в системах тестирования продуктов фирмы «1С» перед их выпуском; - обучение на официальных курсах в УЦ 1С: «[Подготовка к 1С:Эксперту по технологическим вопросам. Применение методик](https://uc1.1c.ru/course/podgotovka-k-1s-ekspertu-po-tehnologicheskim-voprosam-primenenie-metodik/)», «Эксплуатация крупных информационных систем»; - используется фирмой «1С» в своих высоконагруженных коммерческих проектах, например, 1С:Fresh.",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Система управления реляционными базами данных, разработанная корпорацией Microsoft. Основной используемый язык запросов — Transact-SQL, создан совместно Microsoft и Sybase. Transact-SQL является реализацией стандарта ANSI/ISO по структурированному языку запросов (SQL) с расширениями.",
      "why": "",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Хранилище конфигурации предназначено для коллективной разработки конфигурации. Представляет собой базу данных, в которой сохраняются все изменения конфигурации, сделанные в процессе ее разработки. Четыре простейшие операции работы с хранилищем: - Захват объекта - Помещение объекта - Получение объекта - Отмена захвата",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Распределенная система управления версиями. Основное отличие Git’а от любой другой системы контроля версий (включая хранилище конфигурации) - это подход Git’а к работе со своими данными. Концептуально, большинство других систем хранят информацию в виде списка изменений в файлах.",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Онлайн-сервис для разработки и управления проектами. Преимущества: 1. Большой набор инструментов в одной программе: - Конструктор прототипов форм и приложений - Моделирование диаграмм бизнес-процессов, в том числе нотаций BPMN - Канбан-доска и система для групповой и удаленной работы - Полноценный текстовый редактор - Генератор подробных технических заданий - Встроенный ИИ-ассистент с функциями создания и распознавания - Счётчик трудозатрат 2. Упрощает взаимопонимание и согласование между заказчиком и исполнителем 3. Не требует установки и лицензии 1С",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Накидка — это инструмент для 1С:Предприятие 8, который позволяет быстро создавать формы по текстовому описанию. Он использует простой и понятный синтаксис, напоминающий Markdown, а также поддерживает визуальное проектирование элементов интерфейса. Преимущества: 1. Позволяет экономить время разработчика на создание форм 2. Гибкая настройка свойств элементов 3. Легкий и быстрый старт",
    ...
    },
    {
      ...
      "logo": null,
      "description": "Программные инструменты для тестирования конфигураций, созданных на платформе \"1С:Предприятие\". Позволяет автоматизировать проектирование тестов, выполнение тестирования и анализ полученных результатов.",
    ...
    },
    {
      ...
      "subcategory": "Автоматизированное тестирование",
      "logo": null,
      "description": "Набор инструментов для проверки качества решений на платформе 1С:Предприятие. Позволяют проверять поведение различных систем на базе платформы 1С. Возможности: - Готовые \"дымовые тесты\" различных видов - Различные виды тестирования - Проверка поведения - Формирование автодокументации",
    ...
    },
    {
      ...
      "subcategory": "Автоматизированное тестирование",
      "logo": null,
      "description": "Бесплатная программа для сценарного тестирования решений на базе 1С:Предприятие 8.3, управляемые формы. Тестер является инструментом для проведения сценарного тестирования приложений, и призван сохранить и воспроизвести опыт программиста, время на приобретение которого было потрачено на ручные проверки и тестирование. Основным профитом от использования Тестера является повышение качества программ, без существенных организационных изменений, изменений принципов программирования, и других долгосрочных инвестиций времени на выпуски очередных версий продуктов. Тестер может использоваться как независимый инструмент, так и совместно с BDD, выступая в качестве платформы для разработки сложных тестов Особенности: - Быстро устанавливается, не требует специальных (кроме 1С) знаний и программного обеспечения - Быстро интегрируется в процесс разработки - Не требует фундаментального пересмотра философии программирования - Сфокусирован на процесс создания реальных тестов - Не требует подготовки отдельных баз и эталонных данных",
    ...
    },
    {
      ...
      "subcategory": "Автоматизированное тестирование",
      "logo": null,
      "description": "YAxUnit - фреймворк, для тестирования решений на базе 1С:Предприятие 8.3, управляемые формы. YAxUnit представляет собой мощный инструмент написания тестов для решений на платформе 1С:Предприятие. Он был создан с учетом лучших практик тестирования и предлагает множество функций, которые позволяют эффективно справиться с поставленной задачей. Особенности: - [Текучий интерфейс (Fluent interface)](https://bia-technologies.github.io/yaxunit/docs/getting-started/fluent-api) - Легкий вход для применения Test Driven Development (разработка через тестирование) - Позволяют как создавать так и чистить данные за собой, оставляя базу в первоначальном виде - Возможность запускать отдельные тесты - Удобный плагин для EDT",
    ...
    },
    {
      ...
      "logo": null,
      "description": "Встроенная в конфигуратор и EDT проверка конфигурации. Расширенная проверка позволяет находить не только ошибки компиляции модулей.",
    ...
    },
    {
      ...
      "subcategory": "Статический анализ кода",
      "logo": null,
      "description": "Предназначена для автоматизированной проверки конфигураций, разработанных на платформе «1С:Предприятие 8», на соответствие стандартам и иным требованиям технического характера Основные возможности: 1. Разовая проверка на соответствие стандартам разработки 2. Регулярная автоматическая проверка на соответствие стандартам разработки 3. Сравнение качества различных конфигураций 4. Расширяемость",
    ...
    },
    {
      ...
      "subcategory": "Статический анализ кода",
      "logo": null,
      "description": "Поддержка языка 1С:Предприятие 8 и OneScript для SonarQube. SonarQube - платформа для непрерывного анализа и измерения качества программного кода. Возможности: - Дашборд проекта - Подсветка синтаксиса 1С:Предприятие - Расчет базовых метрик и количества строк кода - Регистрация диагностик, предоставляемых BSL Language Server как внутренних правил - Встроенный анализатор - BSL Language Server Diagnostic provider - Импорт результатов внешних анализаторов во внутреннем формате json",
    ...
    },
    {
      ...
      "subcategory": "Прочее",
      "logo": null,
      "description": "Термин “code review” может означать разные действия, от простого чтения какого-то кода из-за спины разработчика до совещания на 20 человек, где вы разбираете код строчка за строчкой.",
    ...
    },
    {
      ...
      "subcategory": "Прочее",
      "logo": null,
      "description": "Система стандартов и методики разработки конфигураций для платформы 1С:Предприятие 8.",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Jenkins — программная система, предназначенная для обеспечения процесса непрерывной интеграции программного обеспечения. Позволяет автоматизировать часть процесса разработки программного обеспечения, в котором не обязательно участие человека. Основные плюсы: 1. Простая установка 2. Простая настройка 3. Расширения и плагины",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Система непрерывной интеграции, входящая в состав Gitlab. Позволяет легко привязывать сборочную линию к коммитам репозитория.",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Vagrant — позволяет создавать и конфигурировать легковесные, повторяемые и переносимые окружения для разработки. Возможности: 1. Изолированные среды. Избегаются возможные конфликты с основной системой 2. Повторяемость. Можно быстро пересоздать рабочую среду буквально одной командой 3. Переносимость. Окружение можно развернуть под любой системой",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Это программное обеспечение для автоматизации развёртывания и управления приложениями в среде виртуализации на уровне операционной системы; позволяет «упаковать» приложение со всем его окружением и зависимостями в контейнер, а также предоставляет среду по управлению контейнерами.",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Инструмент для гибкого, легкого и красивого отображения результатов автотестов.",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Конвертация данных - это инструмент для разработки обменов, предполагающих наличие посредника передачи данных между конфигурациями в виде универсального формата данных EnterpriseData",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Боты — специальные аккаунты в Telegram, созданные для того, чтобы автоматически обрабатывать и отправлять сообщения. Пользователи могут взаимодействовать с ботами при помощи сообщений, отправляемых через обычные или групповые чаты.",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "[Curlone](https://curlone.ru/) - конвертер команды [curl](https://curl.se/) в код на языке 1С.",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "S3 — стандарт API для объектных хранилищ (Yandex Object Storage, Amazon S3, MinIO и другие). Файлы хранятся как объекты с уникальными идентификаторами и доступны по единому HTTP-API.",
    ...
    },
    {
      ...
      "logo": null,
      "description": "Fiddler — сетевой прокси и сниффер, который перехватывает и отображает весь HTTP/HTTPS-трафик между клиентом и сервером. Он полезен, когда необходимо анализировать поведение внешних приложений, увидеть “сырые” запросы и ответы, отследить редиректы, заголовки, куки и многое другое.",
      "why": "",
    ...
    },
    {
      ...
      "subcategory": "Отладка веб-сервисов и интеграций",
      "logo": null,
      "description": "Postman — мощный инструмент для ручного тестирования HTTP-запросов. Позволяет легко отправлять запросы к API, настраивать заголовки, авторизацию и тела запросов, а также проверять ответы. Идеален для разработки, отладки и автоматизации сценариев работы с API.",
      "why": "",
    ...
    },
    {
      ...
      "subcategory": "Отладка веб-сервисов и интеграций",
      "logo": null,
      "description": "OpenAPI UI (бывший Swagger) — автогенерируемая интерактивная документация к REST API. Позволяет визуально просматривать структуру эндпоинтов, типы параметров и возможные ответы, а также отправлять тестовые запросы прямо из браузера. Упрощает работу с API для разработчиков, тестировщиков и интеграторов.",
      "why": "",
    ...
    },
    {
      ...
      "subcategory": "Отладка веб-сервисов и интеграций",
      "logo": null,
      "description": "Ngrok — легкий инструмент для создания временного публичного URL, который проксирует запросы к локальному серверу. Особенно полезен при тестировании входящих webhook-ов от внешних сервисов (например, платёжных систем или мессенджеров), когда локальный сервер должен быть доступен извне.",
      "why": "",
    ...
    },
    {
      ...
      "logo": null,
      "description": "1С:Аналитика — это BI-система, которая поможет вам в работе с аналитическими данными и отлично подойдет для управленческого учета",
    ...
    },
    {
      ...
      "subcategory": "BI-системы",
      "logo": null,
      "description": "Microsoft Power BI — это коллекция программных служб, приложений и соединителей, которые взаимодействуют друг с другом, чтобы превратить разрозненные источники данных в согласованные, визуально иммерсивные и интерактивные аналитические сведения.",
    ...
    },
    {
      ...
      "logo": null,
      "description": "Кластер серверов — это объединение нескольких рабочих серверов в единый ресурс для обслуживания большого числа одновременных пользователей. Состоит из рабочих процессов (`rphost`), агентов сервера (`ragent`) и менеджеров кластера (`rmngr`).",
    ...
    },
    {
      ...
      "subcategory": "Мониторинг и аналитика",
      "logo": null,
      "description": "Кроссплатформенный комплекс для обслуживания и мониторинга информационных баз 1С. Состоит из серверного приложения с веб-интерфейсом и агента, работающего на серверах 1С.",
    ...
    },
    {
      ...
      "logo": null,
      "description": "Базовый экзамен, подтверждающий знание платформы «1С:Предприятие» или типовых конфигураци Формат: 14 тестовых вопросов за 30 минут, минимум 12 правильных",
      "why": "",
      "homepage": null,
      "repo": null,
      "start": [],
    ...
    },
    {
      ...
      "subcategory": "Сертификация от 1С",
      "logo": null,
      "description": "Класс экзаменов для проверки навыков специалистов по внедрению и адаптации прикладного решения под нужды пользователя Фокусируется на внедрении и сопровождении, аналитике бизнес‑процессов типовых конфигураций Формат: решение реальных задач по автоматизации деятельности организации, 3-5 часов",
      "why": "",
      "homepage": null,
      "repo": null,
      "start": [],
    ...
    },
    {
      ...
      "subcategory": "Сертификация от 1С",
      "logo": null,
      "description": "Подтверждает умение решать практические задачи в конфигурациях Формат: Решение задач по учёту, бизнес‑процессам и расчётам за 4 часа.",
      "why": "",
      "homepage": null,
      "repo": null,
      "start": [],
    ...
    },
    {
      ...
      "subcategory": "Сертификация от 1С",
      "logo": null,
      "description": "Глубокая разработка, оптимизация, нестандартные решения. Формат: сложные практические задания и защита проектов перед комиссией.",
      "why": "",
      "homepage": null,
      "repo": null,
      "start": [],
    ...
    },
    {
      ...
      "subcategory": "Сертификация от 1С",
      "logo": null,
      "description": "Умение настраивать и поддерживать крупные информационные системы на базе 1С-решений, выявлять в них проблемы и решать их Формат: [Экзамен](https://uc1.1c.ru/ekzameny-1s/expluatator/) состоит из практической и теоретической части. Практическая часть: — решить не менее 3 из 5 задач Теоретическая часть: — правильно ответить на 14 из 20 письменных вопросов — правильно ответить на 3 из 3 устных вопросов",
      "why": "",
      "homepage": null,
      "repo": null,
      "start": [
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Предназначена для онлайн-тестирования знаний и профессиональных навыков как уже работающих сотрудников, так и соискателей, претендующих на открытые вакансии. Таблица уровня квалификации программистов 1С:Специалист: | Уровень | min | max| Документ | |---------|-----|----|----------| | Junior | 0 | 3,90| Заключение | | Junior-middle| 3,91 | 4,90| Заключение | | Middle| 4,91| 6,80 | Сертификат | | Middle-senior|  6,81| 7,99| Сертификат | | Senior| 8,00| 10,00| Сертификат |",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Подтверждение компетенций с сертификатом на Госуслугах. Тесты от hh.ru, а сертификат от Минцифры России. По 1С тестов нет (пока?). На текущий момент тесты по: - API - Git - Docker - PostgreSQL - SQL - Linux - Регрессионное тестирование - Функциональное тестирование - Алгоритмы и структуры данных - Python, JavaScript, Java, PHP, C# - HTML, CSS",
