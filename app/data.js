  ...
  "items": [
    ...
    },
    {
      ...
      "analogs": [
        ...
        "ПУСК (Панель управления сервисами и компонентами)"
      ],
      "depends": [
    ...
    },
    {
      ...
      "why": "Администрирование инфраструктуры 1С без командной строки: базы, сеансы, блокировки, рабочие процессы кластера и контроль лицензий в одном браузерном интерфейсе. Работает на Linux и Windows",
