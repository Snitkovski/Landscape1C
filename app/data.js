...
window.LANDSCAPE = {
  ...
  "items": [
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Российский сервис многофакторной аутентификации (MFA) для защиты доступа",
      "why": "Второй фактор при входе в системы и 1С: подтверждение через приложение, push, OTP и Telegram для защиты от кражи паролей",
