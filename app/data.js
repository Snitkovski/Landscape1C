...
window.LANDSCAPE = {
  ...
  "items": [
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Продукт 1С для централизованного управления распределенным ландшафтом информационных баз",
      "why": "Управление множеством баз и серверов 1С из одной точки: автоматизация обновлений, регламентных операций и контроля состояния по всему ландшафту",
      "homepage": null,
      "repo": null,
      "start": [],
      "maturity": "продвинутое",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Технология 1С для публикации прикладных решений в облаке по модели SaaS",
      "why": "Запуск 1С как онлайн-сервиса для множества компаний: единая инфраструктура, разделение данных и самообслуживание абонентов",
      "homepage": "https://1cfresh.com/",
      "repo": null,
      "start": [],
      "maturity": "нишевое",
      "origin": "отечественное",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Платформа данных Сбера на базе PostgreSQL для корпоративных нагрузок",
      "why": "Отечественная PostgreSQL-совместимая СУБД под высокие нагрузки 1С: корпоративная поддержка и доработки для больших инсталляций",
      "homepage": "https://platformv.sber.ru/",
      "repo": null,
      "start": [],
      "maturity": "нишевое",
      "origin": "отечественное",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Российский сервис мониторинга производительности и доступности систем 1С",
      "why": "Контроль здоровья и быстродействия 1С в одном месте: сбор метрик, APDEX и оповещения о проблемах без сложной настройки",
    ...
    },
    {
      ...
      "subcategory": null,
      "logo": null,
      "description": "Российская платформа мониторинга и наблюдаемости инфраструктуры и приложений 1С",
      "why": "Единый обзор инфраструктуры и приложений, включая 1С: метрики, логи и трейсы с оповещениями для эксплуатации",
