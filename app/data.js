...
window.LANDSCAPE = {
  ...
  "blocks": [
    { "name": "Проектирование", "categories": ["Прототипирование", "Моделирование и документация"] },
    { "name": "Разработка", "categories": ["Разработка", "Плагины и библиотеки", "ИИ-ассистенты", "Системы хранения версий", "CI/CD"] },
    { "name": "Качество", "categories": ["Повышение качества", "Код-ревью"] },
    { "name": "Инфраструктура и эксплуатация", "categories": ["Администрирование и инфраструктура", "Системы управления базами данных (СУБД)", "Мониторинг", "Производительность и нагрузочное тестирование"] },
    { "name": "Данные и интеграции", "categories": ["Интеграции", "API и веб-сервисы", "BI-системы"] },
    { "name": "Управление и компетенции", "categories": ["Задачи", "Сертификация"] }
  ],
  "axes": {
    "role": {
      "label": "Роль",
  ...
  "items": [
    ...
    },
    {
      ...
      "why": "Даёт командное рецензирование изменений без привязки к конкретному хостингу репозиториев — обзоры можно вести и до коммита.",
    ...
    },
    {
      ...
      "description": "Инструмент рецензирования кода и документов от SmartBear для распределённых команд.",
      "why": "Поддерживает ревью не только кода, но и проектных документов, с настраиваемыми регламентами проверки и отчётностью.",
