...
Витрина результатов — страница `app/survey2026.html` на обвязке сайта
(до публикации «Итогов 2026» исключена из `dist` в `scripts/build.js`,
данные — в `.gitignore`): плитки, срезы по ролям, квадрант
