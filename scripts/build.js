...
// Витрина опроса публикуется по URL /survey2026 (не через меню, noindex).
// Старый тестовый адрес /test_survey оставляем копией — ранние ссылки живут.
const COPY = { "survey2026.html": "test_survey.html" };
...
// 3б. Копии под дополнительными URL (витрина: /survey2026 + старый /test_survey).
